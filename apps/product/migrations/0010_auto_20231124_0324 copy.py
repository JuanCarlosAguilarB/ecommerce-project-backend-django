# Generated by Django 4.0 on 2023-11-24 03:24
...
def create_products(apps, schema_editor):
    ...
    PriceProduct = apps.get_model('product', 'PriceProduct')
    ...
    for product in products:
        ...
        _product.photo.name = product['image']
        _product.save()

        _price_product, _ = PriceProduct.objects.get_or_create(
            product=_product,
            price=product['price'],
        )
        print(_product)
